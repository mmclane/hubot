...
#
# Commands:
# zeke get Users for|or|in awsAccount  - Returns a list of users in specified awsAccount
...
module.exports = (robot) ->
  ...
  robot.respond /get users (for|of|in) (.*)/i, (msg) ->
      ...
      executePowerShell psObject, (error,result) ->
        ...
        if error
          ...
          if result.success is true
            ...
            msg.send ":white_check_mark: I found that the following users in *" + profile + ":*"
