# Description:
# Gets users from IAM and returns their UserNames
#
# Commands:
# zeke get all users  - Returns a list of users in both HL-DEV and HL-PROD
      ...
      executePowerShell psObject, (error,result) ->
        ...
        if error
          ...
          if result.success is true
            ...
            msg.send ":white_check_mark: I found that the following users in *"+result.profile+"*:"
